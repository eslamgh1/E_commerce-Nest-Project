...
exports.BrandModule = BrandModule = __decorate([
    (0, common_1.Module)({
        imports: [DB_1.BrandModel, DB_1.UserModel],
        controllers: [brand_controller_1.BrandController],
        providers: [brand_service_1.BrandService, token_services_1.TokenService, jwt_1.JwtService, DB_1.UserRepo, DB_1.BrandRepo, common_2.S3Service]
    })
], BrandModule);
