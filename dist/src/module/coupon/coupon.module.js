...
exports.CouponModule = CouponModule = __decorate([
    (0, common_1.Module)({
        imports: [DB_1.BrandModel, DB_1.UserModel, DB_1.CouponModel],
        controllers: [coupon_controller_1.couponController],
        providers: [coupon_service_1.CouponService, token_services_1.TokenService, jwt_1.JwtService, DB_1.UserRepo, DB_1.BrandRepo, common_2.S3Service, DB_1.CouponRepo]
    })
], CouponModule);
