...
export class SubCategoryController {
    ...
    // 3-----------------------Api : update Image subcategory
    @Auth({
        role: [userRole.USER],
        typeToken: TokenTypeEnum.access
    })
